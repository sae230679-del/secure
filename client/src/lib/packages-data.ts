import { SERVICE_1_CRITERIA, SERVICE_2_CRITERIA, totalCount } from "@shared/criteria-registry";

export const SERVICE_1_CRITERIA_COUNT = totalCount(SERVICE_1_CRITERIA);
...
export const EXPRESS_PACKAGE = {
  ...
  durationMin: 5,
  durationMax: 10,
  description: "Детальный отчёт с анализом каждого нарушения",
  features: [
...
export const FULL_AUDIT_PACKAGES = {
  landing: {
    ...
    siteType: "landing",
    price: 3900,
    criteriaCount: SERVICE_2_CRITERIA_COUNT,
    durationMin: 15,
    durationMax: 30,
    description: "Аудит одностраничного сайта (до 3 страниц)",
    features: [
      `Полный аудит по ${SERVICE_2_CRITERIA_COUNT} критериям`,

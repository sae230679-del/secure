        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-4 flex-1 min-w-0 flex-wrap">
              <div className="relative flex-1 min-w-[200px] max-w-sm">
                ...
                <Input
                  ...
                  className="pl-10"
                  data-testid="input-search-admin-audits"
                />
              </div>
            ...
            <p className="text-sm text-muted-foreground">
              {filteredAudits?.length || 0} аудитов
            </p>
          </div>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-4">
              {filteredAudits.map((audit) => (
                <div
                  ...
                  data-testid={`admin-audit-card-${audit.id}`}
                >
                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground mt-1 flex-wrap">
                      ...
                      {audit.package && (
                        <span className="font-medium">
                          {formatPrice(audit.package.price)}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2">Нет оплаченных аудитов</h3>
              <p className="text-muted-foreground">
                {search || statusFilter !== "all"
                  ? "Попробуйте изменить параметры поиска"
                  : "Здесь будут отображаться аудиты с подтвержденной оплатой"}
              </p>
            </div>
          )}
        </CardContent>

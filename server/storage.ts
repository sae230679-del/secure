...
export class DatabaseStorage implements IStorage {
  ...
  async ensureDefaultPackages(): Promise<void> {
    const defaultPackages = [
      ...
      { type: "expressreport", name: "Экспресс‑отчёт", price: 900, criteriaCount: 10, durationMin: 1, durationMax: 5, description: "Подробный отчёт по результатам экспресс-проверки", features: ["Детальный анализ нарушений", "Рекомендации по исправлению", "Оценка рисков и штрафов"], category: "express_report" },
